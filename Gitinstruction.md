...
После нажатия на этот пункт перед вами появится страница где вы можете настроить параметры репозитория, включая его доступность другим пользователям сайта, ваш репозиторий может быть публичным или приватным, в конце этой страницы вы найдете зелёную кнопку **Создать репозиторий**
...
### Использование чужого репозитория с Github использование pull request
Для использования чужого репозитория в рамках Open Source разработки(добавления фич, упрощения кода, и прочей помощи разработчику) вам потребуется как и в случае с открытм перейти к нему на сайте Github. Но вместо копирования копирования в правом верхем углу нужно нажать кнопку Fork таким образом мы создаем свою копию этого репозитория, в которой мы можем работать. Она появляется на нашем аккаунте с которого мы можем его скачать так же как если бы это был наш репозиторий. После внесения изменений в репозиторий вам как и ареньше надо будет воспользоваться командой 
```
git push
```
Для того что бы измененная версия оказалась на нашем аккаунте на сайте. Зайдя туда 
вы увидите что в этом репозитории появилась кнопка Compare and pull request.
Нажав эту кнопку вы отправите измененную вами копию репозитория его разработчику, которую в свою очередь он может проверить и добавить к своему проекту или нет.
